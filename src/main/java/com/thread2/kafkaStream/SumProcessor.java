...
public class SumProcessor implements Processor<String, String> {
    ...
    public void process(String s, String s2) {
        ...
        System.out.println("这个SumProcessor对应处理"+context.topic()+"的第"+context.partition()+"的offset为"+context.offset()+"的记录");
        ...
        System.out.println("现在SumProcessor需要聚合的是:"+key+",value:"+value);
        ...
        if(v == null){
            ...
            System.out.println("本地状态库中已有"+ key +",当前值v为："+v);
